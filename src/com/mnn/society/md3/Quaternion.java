...
//              scale = (float)sin(temp_angle);
  ...
  public void createFromMatrix(float[] pTheMatrix, int rowColumnCount)
  {
        ...
        {
        		Logger.log(Logger.LOG_CLIENT, "CLIENT : Quaternion : primeiro else");
                ...
                {
                		Logger.log(Logger.LOG_CLIENT, "CLIENT : Quaternion : segundo else");
                ...
                {       
                		Logger.log(Logger.LOG_CLIENT, "CLIENT : Quaternion : terceiro else");
