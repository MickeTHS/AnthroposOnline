package com.mnn.society.graphics.textures;
...
public class TextureLoader {
    ...
    public static int loadSharedTexture(String filename) {
    	for(int i = 0; i < textureList.size(); i++) {
    		if(textureList.get(i).equalsIgnoreCase(filename))
    			return i+1;
    	}
    	
    	int t = VBOHandler.loadTexture(filename);
